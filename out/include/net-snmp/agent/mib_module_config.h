...
/* Define if compiling with the STEVE-TEST-MIB module files.  */
#define USING_STEVE_TEST_MIB_MODULE 1
 
/* Define if compiling with the default_modules module files.  */
#define USING_DEFAULT_MODULES_MODULE 1
 
/* Define if compiling with the STEVE-TEST-MIB/demoIpTable/demoIpTable module files.  */
#define USING_STEVE_TEST_MIB_DEMOIPTABLE_DEMOIPTABLE_MODULE 1
...
/* Define if compiling with the STEVE-TEST-MIB/demoIpTable/demoIpTable_interface module files.  */
#define USING_STEVE_TEST_MIB_DEMOIPTABLE_DEMOIPTABLE_INTERFACE_MODULE 1
 
/* Define if compiling with the STEVE-TEST-MIB/demoIpTable/demoIpTable_data_access module files.  */
#define USING_STEVE_TEST_MIB_DEMOIPTABLE_DEMOIPTABLE_DATA_ACCESS_MODULE 1
 
/* Define if compiling with the STEVE-TEST-MIB/demoIpTable/demoIpTable_data_get module files.  */
#define USING_STEVE_TEST_MIB_DEMOIPTABLE_DEMOIPTABLE_DATA_GET_MODULE 1
 
/* Define if compiling with the STEVE-TEST-MIB/demoIpTable/demoIpTable_data_set module files.  */
#define USING_STEVE_TEST_MIB_DEMOIPTABLE_DEMOIPTABLE_DATA_SET_MODULE 1
